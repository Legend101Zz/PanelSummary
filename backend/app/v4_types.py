...
class V4Panel:
    ...
    # Phase 4: panel art generated by the multimodal image renderer.
    # ``image_path`` is a relative path under the project's media directory
    # so the API can serve it; ``image_aspect_ratio`` records the ratio the
    # renderer requested (so the front-end can size the canvas without a
    ...
    def to_dict(self) -> dict:
        ...
        if self.image_aspect_ratio:
            d["image_aspect_ratio"] = self.image_aspect_ratio
        return d
